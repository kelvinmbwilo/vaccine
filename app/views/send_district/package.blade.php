...
//$stock = $facility->stock()->where('vaccine_id',$package->vaccine_id)->get();
//$level=0;
//if($stock){
...
?>
    <div class="col-sm-12" id="add" style="margin-top: 20px">
        ...
        @endif
        {{ Form::open(array("url"=>url("district_package/addpack"),"class"=>"form-horizontal","id"=>'FileUploader6')) }}
        <div class="col-sm-2">
...
<script>
    ...
    function afterSuccess(){
        ...
        $("#listuser").load("<?php echo url("district_package/send/list") ?>/"+$("#qrform input[name=id]").val())
    }
    });
</script>