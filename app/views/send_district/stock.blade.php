...
<div class="col-sm-12">
    <div class="col-sm-4">
        <h4>Facility: <span class="lead">{{ Auth::user()->district->district }} District Store</span></h4>

    </div>
    <div class="col-sm-4">
        <h4>Target Population <span class="lead">{{ Auth::user()->district->tagert_population }}</span></h4>
    </div>
    <div class="col-sm-4">
...
<script>
    $(document).ready(function (){
        ...
        $('#qrform').on('submit', function(e) {
            ...
            $(this).ajaxSubmit({
                url : '<?php echo url('district_package/stock/checklot') ?>/'+$('input[name=lot]').val(),
                target: '#output',
