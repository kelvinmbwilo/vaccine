<h3 class="lead text-center" style="font-size: 30px">Package Information to  {{ $natpack->district->district }} District  <a href="#" class="pull-right" title="Print voucher"><i class="fa fa-print"></i> </a> </h3>
